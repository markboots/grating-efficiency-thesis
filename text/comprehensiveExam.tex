...
Modelling the efficiency of diffraction gratings, with the goal of producing an optimized design for the soft x-ray . Produced software to automate this process. Used the tools to understand efficiency trends, create a novel design for the spectrometer working with david muir.  Measured the actuall efficiency of the gratings

In this comprehensive report, I give the motivation for the project, a history of the developments in grating theory, and set up the theory that I used to model

The rest of my thesis draft covers.

The remaing

By using a fitting routine to match the calculated efficiencies to the reflectometer measurements, I have discovered that I can use the efficiency calculations to predict the parameters of the real-world gratings (such as groove geometry, density, and even non-ideal effects such as surface roughness and oxidation).  For all of the gratings I studied, the predictions turn out to be consistent with AFM (atomic force microscopy) and PSD (power spectral density) characterization measurements of the real grating parameters.  This shows that grating efficiency calculations are not only useful in the design and optimization of soft x-ray instruments, but also a powerful tool in the characterization of their performance.
