...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=4.5in]{Extended/GratingCartoons/fraunhoferCartoon_lowRes.png} 
...
\end{quote}
   \caption{Early spectroscopy would have involved long hours squinting through telescope eyepieces at barely visible lines\ldots although we cannot argue with the value of the results!  \textbf{Image credit:} John McCleod, personal communication, August 2012.}
