...
\end{quote}
   \caption[Early spectroscopy would have involved long hours squinting through telescope eyepieces at barely visible lines.]{Early spectroscopy would have involved long hours squinting through telescope eyepieces at barely visible lines\ldots although we cannot argue with the value of the results!  \textbf{Image credit:} \textsc{John McCleod}, personal communication, August 2012.}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
  \includegraphics[width=\textwidth]{../data/Chapter1/1c_monoExample/1c_bessy_HE-PGM-3.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\textwidth]{../data/Chapter1/1d_spectrometerExample/1d_bl801SXF_2.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \hspace*{-0.25in}\includegraphics[scale=0.71]{../data/Chapter1/1f_spectrometerResolution/1f_2.pdf} 
