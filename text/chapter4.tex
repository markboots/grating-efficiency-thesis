...
\begin{table}[h]
   \centering
   \caption{Predicted resolution and grating efficiency of the REIXS spectrometer at the emission lines of interest.  Values are listed for all gratings where emission energy lies within the detector's motion range.}
   {\footnotesize
