...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\textwidth]{../data/Chapter2/2e_methodComparision/methodComparisonTable_noPre2000.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\textwidth]{../data/Chapter2/2b_rayleighExpansion/2b.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\textwidth]{Extended/RefractiveIndexTolerance/refractiveIndexTolerance.pdf} 
