...
Now we can numerically integrate the electric field components from $y_{m-1}$ to $y_m$ as before, using Equation \eq{matrixDE}.  From the second pair of boundary conditions, we can compute $V^{(m)}_p$ at the end of the integration:
\begin{align}
...
TODO solving final rayleigh coefficients.
