...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[scale=1]{Chapter2/2a_inPlaneIncidence/2a.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\aFigureWidth]{../data/Chapter2/2e_methodComparision/methodComparisonTable_noPre2000.pdf} 
...
\begin{figure}[p] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[scale=0.75]{../data/Chapter2/2d_stacksOfGratings/2d_1.pdf} 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\aFigureWidth]{Chapter2/2d_stacksOfGratings/2d_3.pdf} 
...
\end{align}
Equations \eq{SmatZ}, \eq{Smat22}, and \eq{Smat12} give us exactly what we need to iterate vertically through a stack of grating layers.  The calculation of the $S$ matrix for a full grating begins at layer 1, where no reflection occurs and the transmission is unity for all incoming waves:
\begin{align}
S^{(1)}_{12} &= 0,\\
S^{(1)}_{22} &= \mathbb{1}.
\end{align}
...
\end{align}
The rest of the stack is solved inductively by computing the $T^{(q+1)}$ matrix at each layer $q+1$, and then using Equations \eq{SmatZ}, \eq{Smat22}, and \eq{Smat12} to determine $S^{(q+1)}$, until we reach the top layer.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\aFigureWidth]{Extended/RefractiveIndexTolerance/refractiveIndexTolerance.pdf} 
